# Vocabolario: Tempo e Meteo (Время и погода)
...
|-----------|-----------------|-----------|----------|
| понедельник | ponedel'nik | pa-ni-DYEL-nik | lunedi |
| вторник | vtornik | FTOR-nik | martedi |
| среда | sreda | sri-DA | mercoledi |
| четверг | chetverg | chit-VYERG | giovedi |
| пятница | pjatnitsa | PYAT-ni-tsa | venerdi |
| суббота | subbota | su-BO-ta | sabato |
| воскресенье | voskresen'e | va-skri-SYE-nye | domenica |

Per dire "di lunedi" si usa В + accusativo: в понедельник (v ponedel'nik).
...
| Cirillico | Traslitterazione | Pronuncia | Italiano |
|-----------|-----------------|-----------|----------|
| январь | janvar' | yan-VAR | gennaio |
| февраль | fevral' | fiv-RAL | febbraio |
| март | mart | MART | marzo |
| апрель | aprel' | ap-RYEL | aprile |
| май | maj | MAJ | maggio |
| июнь | ijun' | i-YUN | giugno |
| июль | ijul' | i-YUL | luglio |
| август | avgust | AV-gust | agosto |
| сентябрь | sentjabr' | sin-TYABR | settembre |
| октябрь | oktjabr' | ak-TYABR | ottobre |
| ноябрь | nojabr' | na-YABR | novembre |
| декабрь | dekabr' | di-KABR | dicembre |

Per dire "a gennaio" si usa В + prepositivo: в январе (v janvarje).
...
| Cirillico | Traslitterazione | Pronuncia | Italiano |
|-----------|-----------------|-----------|----------|
| весна | vesna | vis-NA | primavera |
| лето | leto | LYE-ta | estate |
| осень | osen' | O-sin | autunno |
| зима | zima | zi-MA | inverno |
...
| Cirillico | Traslitterazione | Pronuncia | Italiano |
|-----------|-----------------|-----------|----------|
| погода | pogoda | pa-GO-da | tempo (meteo) |
| солнце | solntse | SON-tse | sole |
| дождь | dozhd' | DOSHT | pioggia |
| снег | sneg | SNYEK | neve |
| ветер | veter | VYE-ter | vento |
| облако | oblako | O-bla-ka | nuvola |
| гроза | groza | gra-ZA | temporale |
| туман | tuman | tu-MAN | nebbia |
| жарко | zharko | ZHAR-ka | fa caldo |
| холодно | cholodno | CHO-lad-na | fa freddo |
| тепло | teplo | tip-LO | fa mite |
...
| Cirillico | Traslitterazione | Pronuncia | Italiano |
|-----------|-----------------|-----------|----------|
| сегодня | segodnja | si-VOD-nya | oggi |
| вчера | vchera | fchi-RA | ieri |
| завтра | zavtra | ZAF-tra | domani |
| сейчас | sejchas | si-CHAS | adesso |
| потом | potom | pa-TOM | dopo/poi |
| скоро | skoro | SKO-ra | presto |
| утром | utrom | U-tram | di mattina |
| днём | dnjom | DNYOM | di pomeriggio |
| вечером | vecherom | VYE-chi-ram | di sera |
| ночью | noch'ju | NO-chyu | di notte |
| всегда | vsegda | fsig-DA | sempre |
| никогда | nikogda | ni-kag-DA | mai |
| иногда | inogda | i-nag-DA | a volte |
| часто | chasto | CHA-sta | spesso |
| редко | redko | RYED-ka | raramente |
...
| Cirillico | Traslitterazione | Pronuncia | Italiano |
|-----------|-----------------|-----------|----------|
| Какая сегодня погода? | Kakaja segodnja pogoda? | ka-KA-ya si-VOD-nya pa-GO-da | Com'e il tempo oggi? |
| Сегодня идёт дождь | Segodnja idjot dozhd' | si-VOD-nya i-DYOT DOSHT | Oggi piove |
| На улице холодно | Na ulitse cholodno | na U-li-tse CHO-lad-na | Fuori fa freddo |
| Какое сегодня число? | Kakoe segodnja chislo? | ka-KO-ye si-VOD-nya chis-LO | Che data e oggi? |
